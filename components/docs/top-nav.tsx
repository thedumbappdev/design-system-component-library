...
import { MobileNavOverlay } from "@/components/docs/mobile-sidebar";
				...
				<div className="rounded-2xl border border-border/50 bg-background/80 px-4 sm:px-6 backdrop-blur-xl supports-backdrop-filter:bg-background/60 shadow-[0_8px_32px_-12px_rgba(0,0,0,0.08)] dark:shadow-[0_8px_32px_-12px_rgba(0,0,0,0.3)]">
					<div className="flex h-14 items-center justify-between">
						<div className="flex items-center gap-3">
							{/* Menu trigger - mobile/tablet only */}
							<button
								...
								className={[
									"flex lg:hidden items-center justify-center size-9 rounded-xl",
							...
							>
								...
								<span className="text-foreground hidden sm:block">Design System</span>
							</Link>
						</div>
